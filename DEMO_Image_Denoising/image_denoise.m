function [y,D,D_not_normalized, nz] = image_denoise(params,msgdelta)
...
%%%%% Low Displacement Rank Dictionary Learning %%%%%

if (msgdelta>0)
  disp('Low Displacement Rank Dictionary training...');
end
[D, D_not_normalized] = lowdisp_dict_learn(params);
